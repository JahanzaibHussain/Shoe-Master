    ...
    return (
        <footer className="mt-6 border-primary border-t-2 border-b-2 pb-6">
            <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="w-full pt-6 text-center md:text-right flex md:flex-row justify-center items-center">
                <ul className="text-white">
                    ...
                    <li><Link className="hover:text-primary  transition duration-500 " to="#">  jahanzaibhussain <i className="fa fa-github" aria-hidden="true"></i></Link></li>
                </ul>
                </div>
            </div>
        </footer>
